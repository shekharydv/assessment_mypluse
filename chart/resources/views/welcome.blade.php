...
<head>
    ...
    <title>Chandrashekhar Yadav</title>
  ...
  <header class="relative w-full border-b bg-white pb-4">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
      <div class="inline-flex items-center space-x-2">
        ...
        <span class="font-bold">Chandrashekhar</span>
      </div>
      ...
      <div class="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
        <div class="mt-8 flex max-w-max items-center space-x-2 rounded-full bg-gray-100 p-1">
          <div class="rounded-full bg-white p-1 px-2">
            <p class="text-sm font-medium">Please Click on the links Below </p>
          </div>
          <p class="text-sm font-medium"></p>
        </div>
        
        <p  align="justify" class="mt-8 text-lg text-gray-700">
        <li> <strong><a href="ass1">Chart 1</a></strong></li>
        <li> <strong> <a href="ass2">Chart 2</a></strong></li>
        <li><strong> <a href="ass3">Chart 3</a></strong></li>
        <li><strong> <a href="ass4">Chart 4</a></strong></li>
        <li> <strong><a href="ass5">Chart 5</a></strong></li>
